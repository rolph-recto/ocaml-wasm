...
module Error = Wasm_error
module Encode = Wasm_encode
module Source = Wasm_source
module I32 = Wasm_i32
module I64 = Wasm_i64
module F32 = Wasm_f32
module F64 = Wasm_f64
module I32_convert = Wasm_i32_convert
module I64_convert = Wasm_i64_convert
module F32_convert = Wasm_f32_convert
module F64_convert = Wasm_f64_convert
